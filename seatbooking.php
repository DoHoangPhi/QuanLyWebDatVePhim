...
<h3><center>Hãy chọn ghế muốn đặt</center></h3>
</div>
   <?php
...
<div class="container">
    ...
    <div class="seatCharts-container">
        ...
        <div class="front">MÀN HÌNH CHIẾU</div>
    ...
    <div class="col-lg-6">
        ...
        <table>
            <tr><td width="50%"><font color="blue" size="5px" style="font-family: Shruti;">Phim:</font></td>
                <td bgcolor="79F9E2"><center><font size=5 style="font-family: Shruti; "><?php echo $_GET['movie'];?></font></center></td>
            </tr>
            <tr><td width="50%"><font color="blue" size="5px" style="font-family: Shruti;">Thời gian:</font></td>
                <td bgcolor="ECF68C"><center><font size=5 style="font-family: Shruti;"><?php echo $_GET['time'];?></font></center></td>
            </tr>
            <tr><td width="50%"><font color="blue" size="5px" style="font-family: Shruti;">Ghế:</font></td>
                <td> <input type="text" id="selectedtext" name="seats" placeholder="selected checkboxs"></td>
            </tr>
            <tr><td width="50%"><font color="blue" size="5px"style="font-family: Shruti;">Tổng ghế:</font></td>
...
?>
   <div class="col-lg-12">
            <div class="form-group">
                    <input type="submit" value="Thanh Toán" name="submit" class="form-control btn btn-primary py-2">
                  </div>
    </div>
