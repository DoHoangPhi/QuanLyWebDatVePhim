...
<div class="card ">
                <div class="card-header">
                    <center><img src="img/movienhom7.png" width="40%">
                ...
                ?>
                    ...
                    <center><h3>Tên phim: <?php echo $row['movie'];?></h3></center>

                   <table>
                   	<tr>
                   	<th>Tên</th><th style="padding: 1px 105px;">Thành phố</th>
                   </tr>
                   <tr>
                   	<td><?php echo $row['username'];?></td><td style="padding: 12px 105px;"><?php echo $row['city'];?></td>
                   </tr>
                   <tr>
                   	<th>Email</th><th style="padding: 1px 105px;">Số điện thoại</th>
                   </tr>
                   <tr>
                   	<td><?php echo $row['email'];?></td><td style="padding: 12px 105px;"><?php echo $row['mobile'];?></td>
                   </tr>
                   <tr>
                   	<th>Ngày thanh toán</th><th style="padding: 1px 105px;">Số tiền thanh toán</th>
               	  </tr>
               	  <tr>
