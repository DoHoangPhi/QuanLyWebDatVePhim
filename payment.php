...
<body>
    ...
    <div class="row mb-4">
        <div class="col-lg-8 mx-auto text-center">
            <h1 class="display-6">CHI TIẾT VÉ</h1>
        </div>
    </div> <!-- End -->
    <div class="row">
                    ...
                    <div class="tab-content">
                        <div class="row">
                           ...
                           if (mysqli_num_rows($result) > 0) {
                                ...
                                Tên người dùng: '.$row['username'].'<br>
                                Số điện thoại: '.$row['mobile'].'<br>
                                Tên phim: '.$_POST['movie'].'<br>
                                Chỗ ngồi: '.implode(",", $_POST["seat"]).' <br>
                                Ngày thanh toán: '.date("D-m-y ",strtotime('today')).'
                                </div>
                            <div class="col-lg-6">
                                
                                Email: '.$row['email'].'<br>
                                Thành phố: '.$row['city'].'<br>
                                
                                Tổng số ghế: '.$_POST['totalseat'].' <br>
                                Thời gian: '.$_POST['show'].'<br>
                                Ngày đặt: '.date("D-m-y ",strtotime('tomorrow')).'
                        ...
                        <div id="credit-card" class="tab-pane fade show active pt-3">
                                ...
                                <div class="seatCharts-container">
                                             ...
                                             <div class="front">
                                                ...
                                                <font text-align="right"><?php echo $price;?>đ</font>
                                            </div>
                                </div>
                            </div>
                                <div id="msg"></div>
