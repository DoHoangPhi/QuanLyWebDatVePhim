...
<div>
    	...
    	<div class="" style="background: #F2D7D5">
			...
			<td align="center" valign="middle">
				<div class="loginholder">
					...
					<tr>
  						 ...
  						 <a href="./index.php"><img src="img/movienhom7.png" alt="" width="180px"></a>
					</tr>
					<tr>
              ...
              <br><p id="passerror"></p><div id="msg"></div> </td>
					...
					<tr>
						<td align="center"><br />
						 ...
						 <button class="btn-normal" id="login">Đăng Nhập</button>
						</td>
					</tr>
					<tr>
						<td align="left"><br />
						<span class="forgetpassword"><a href="forget_password.php"> Quên mật khẩu ?</a></span></td>

					</tr>
					<td><a href="register_form.php"> Đăng ký ngay</a></td>
					<tr>
