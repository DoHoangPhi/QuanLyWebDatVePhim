        ...
        <div class="col-md-10">
           <div class="row align-items-center">
            <div class="col-lg-7 mb-5 mb-lg-0">
              ...
              <h2 class="mb-5">Điền vào mẫu đơn.</h2>
...
<div class="col-lg-12">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <h3>Bạn cần đăng nhập để gửi</h3>
...
?>
                <div class="row">
                  <div class="col-md-12">
                              <button type="button" id="feedbackform" class="btn btn-primary">Gửi</button>          
                  </div>
                </div>
<?php }
              ?>
            ...
            <div class="col-lg-4 ml-auto">
              <h3 class="mb-4">Hãy nói về mọi thứ.</h3>
              <p>Hãy để chúng tôi ghi lại những suy nghĩ và đề xuất của bạn về cách chúng tôi có thể khảo sát bạn tốt hơn. Hãy cho chúng tôi phản hồi về cảm nhận của bạn về dịch vụ của chúng tôi.</p>
